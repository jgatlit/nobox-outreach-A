  ...
  strategicDifferentiators: {
    technicalStackAdvantage: {
      ...
      points: [
        ...
        "Unified digital and AI approach: Integrates web design, digital marketing, and AI-driven automation for a seamless, high-impact sales pipeline." //[1][7]
      ]
    },
    performanceMetrics: {
      ...
      points: [
        ...
        "Websites and SEO campaigns routinely drive measurable increases in qualified inbound leads and pipeline velocity." //[1][6][12]
      ]
    }
  },
  ...
  customerValueProposition: {
    ...
    points: [
      ...
      },
      {
        ...
        description: "Custom web design and integrated SEO ensure your brand stands out and is easily found by decision-makers at every stage of the B2B buying journey." //[1][4][7]
      },
      {
        name: "Sustainable Pipeline Growth",
        description: "Digital marketing and SEO strategies drive ongoing traffic and nurture leads, compounding returns and building long-term trust and authority." //[6][12][14]
      }
    ],
